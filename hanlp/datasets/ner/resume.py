...
RESUME_NER_TRAIN = f'{_RESUME_NER_HOME}ResumeNER/train.char.bmes'
'''Training set of Resume in char level.'''
RESUME_NER_DEV = f'{_RESUME_NER_HOME}ResumeNER/dev.char.bmes'
'''Dev set of Resume in char level.'''
RESUME_NER_TEST = f'{_RESUME_NER_HOME}ResumeNER/test.char.bmes'
