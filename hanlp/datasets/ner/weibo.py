...
WEIBO_NER_TRAIN = f'{_WEIBO_NER_HOME}weiboNER_2nd_conll.train'
'''Training set of Weibo in char level.'''
WEIBO_NER_DEV = f'{_WEIBO_NER_HOME}weiboNER_2nd_conll.dev'
'''Dev set of Weibo in char level.'''
WEIBO_NER_TEST = f'{_WEIBO_NER_HOME}weiboNER_2nd_conll.test'
